...
class RewarderConfig:
    ...
    tanh_squash_rewards: bool = False  # Whether to squash rewards with tanh
...
class VesselConfig:
    ...
    look_ahead_distance: int = 150  # Path look-ahead distance for vessel [m]
...
class SensorConfig:
    ...
    image_observation_range: float = 160.0  # Range of image observation from center to edge [m]
